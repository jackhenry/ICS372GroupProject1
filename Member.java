...
public class Member implements Serializable {
	...
	/**
	 * Idea is creating the productPurchased List to store all of product in the certain time.
	 * If the customer want to return, the returned products should be in this list. 
	 */
	...
	// FIXME
	// I am not sure these lines of code. I want to save the purchased products on the list
